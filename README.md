...
*LookerSingleSignOnApi* | [**getSSOEndpoint**](docs/Api/LookerSingleSignOnApi.md#getssoendpoint) | **GET** /api/v1.0/{appId}/looker/sso | Get the single sign on embed URL for PerformanceSummary Dashboard
