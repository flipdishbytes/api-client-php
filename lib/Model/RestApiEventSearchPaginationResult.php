...
/**
 * RestApiEventSearchPaginationResult Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Flipdish\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RestApiEventSearchPaginationResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RestApiEventSearchPaginationResult';
    ...
    protected static $swaggerTypes = [
        'data' => '\Flipdish\Client\Model\EventSearchResult',
        'page' => 'int',
        'limit' => 'int',
     ...
     * Sets data
     *
     * @param \Flipdish\Client\Model\EventSearchResult $data Event results
     *
     * @return $this
     */
