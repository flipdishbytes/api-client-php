...
/**
 * MenuItemOptionSet Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MenuItemOptionSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MenuItemOptionSet';
    ...
    protected static $swaggerTypes = [
        ...
        'image_url' => 'string',
        'menu_item_option_set_items' => '\Flipdish\Client\Model\MenuItemOptionSetItem[]',
        'public_id' => 'string',
        'name' => 'string',
     ...
     *
     * @param \Flipdish\Client\Model\MenuItemOptionSetItem[] $menu_item_option_set_items Option set items
     *
     * @return $this
     */
