...
class App implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'app_id' => 'string',
        'name' => 'string',
        'map_center' => '\Flipdish\Client\Model\Coordinates',
        'map_north_east' => '\Flipdish\Client\Model\Coordinates',
        'map_south_west' => '\Flipdish\Client\Model\Coordinates',
        'app_access_level' => 'string',
        'icon_url' => 'string',
        'icon_thumbnail_url' => 'string',
        'country_id' => 'string',
        'available_app_languages' => '\Flipdish\Client\Model\Language[]'
    ];
     ...
     * Sets map_center
     *
     * @param \Flipdish\Client\Model\Coordinates $map_center Center of the map coordinates
     *
     * @return $this
     */
     ...
     * Sets map_north_east
     *
     * @param \Flipdish\Client\Model\Coordinates $map_north_east North East(Top Right) Corner of the map coordinates
     *
     * @return $this
     */
     ...
     * Sets map_south_west
     *
     * @param \Flipdish\Client\Model\Coordinates $map_south_west South West (Bottom Left) Corner of the map coordinates
     *
     * @return $this
     */
     ...
     *
     * @return \Flipdish\Client\Model\Language[]
     */
     ...
     *
     * @param \Flipdish\Client\Model\Language[] $available_app_languages Available Languages for Apps\\Staff
     *
     * @return $this
     */
