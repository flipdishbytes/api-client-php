...
/**
 * StoreGroupDeletedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Group Deleted Event
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreGroupDeletedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreGroupDeletedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Model\UserEventInfo $user User which deleted this store group
     *
     * @return $this
     */
     ...
     * Sets store_group
     *
     * @param \Flipdish\Client\Model\StoreGroup $store_group Deleted store group
     *
     * @return $this
     */
