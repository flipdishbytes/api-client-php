...
/**
 * StoreDeletedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Deleted Event
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreDeletedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreDeletedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Model\UserEventInfo $user User which deleted this store
     *
     * @return $this
     */
     ...
     * Sets store
     *
     * @param \Flipdish\Client\Model\Store $store Deleted Store
     *
     * @return $this
     */
