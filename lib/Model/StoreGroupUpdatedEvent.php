...
/**
 * StoreGroupUpdatedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Group Updated Event
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreGroupUpdatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreGroupUpdatedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Model\UserEventInfo $user User which updated this store group
     *
     * @return $this
     */
     ...
     * Sets store_group
     *
     * @param \Flipdish\Client\Model\StoreGroup $store_group Updated store group
     *
     * @return $this
     */
