...
class VouchersApi
{
     ...
     * @return \Flipdish\Client\Model\RestApiResultVoucherWithStats
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultVoucherWithStats, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVoucherByIdWithHttpInfo($voucher_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultVoucherWithStats';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultVoucherWithStats',
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiArrayResultVoucherDataPoint
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiArrayResultVoucherDataPoint, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVoucherStatsByIdWithHttpInfo($voucher_id, $aggregate_data_by, $data_point_limit = null)
    {
        $returnType = '\Flipdish\Client\Model\RestApiArrayResultVoucherDataPoint';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiArrayResultVoucherDataPoint',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  bool $is_enabled Is enabled (optional)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiPaginationResultVoucherSummary
     */
    public function getVouchers($app_id, $page_index = null, $page_size = null, $search_codes = null, $status_search = null, $type_search = null, $sub_type_search = null, $store_ids = null, $is_enabled = null)
    {
        list($response) = $this->getVouchersWithHttpInfo($app_id, $page_index, $page_size, $search_codes, $status_search, $type_search, $sub_type_search, $store_ids, $is_enabled);
        return $response;
    }
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiPaginationResultVoucherSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVouchersWithHttpInfo($app_id, $page_index = null, $page_size = null, $search_codes = null, $status_search = null, $type_search = null, $sub_type_search = null, $store_ids = null, $is_enabled = null)
    {
        $returnType = '\Flipdish\Client\Model\RestApiPaginationResultVoucherSummary';
        $request = $this->getVouchersRequest($app_id, $page_index, $page_size, $search_codes, $status_search, $type_search, $sub_type_search, $store_ids, $is_enabled);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiPaginationResultVoucherSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsync($app_id, $page_index = null, $page_size = null, $search_codes = null, $status_search = null, $type_search = null, $sub_type_search = null, $store_ids = null, $is_enabled = null)
    {
        return $this->getVouchersAsyncWithHttpInfo($app_id, $page_index, $page_size, $search_codes, $status_search, $type_search, $sub_type_search, $store_ids, $is_enabled)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsyncWithHttpInfo($app_id, $page_index = null, $page_size = null, $search_codes = null, $status_search = null, $type_search = null, $sub_type_search = null, $store_ids = null, $is_enabled = null)
    {
        $returnType = '\Flipdish\Client\Model\RestApiPaginationResultVoucherSummary';
        $request = $this->getVouchersRequest($app_id, $page_index, $page_size, $search_codes, $status_search, $type_search, $sub_type_search, $store_ids, $is_enabled);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVouchersRequest($app_id, $page_index = null, $page_size = null, $search_codes = null, $status_search = null, $type_search = null, $sub_type_search = null, $store_ids = null, $is_enabled = null)
    {
        ...
        if (is_array($search_codes)) {
            $search_codes = ObjectSerializer::serializeCollection($search_codes, 'multi', true);
        }
        ...
        if (is_array($status_search)) {
            $status_search = ObjectSerializer::serializeCollection($status_search, 'multi', true);
        }
        ...
        if (is_array($type_search)) {
            $type_search = ObjectSerializer::serializeCollection($type_search, 'multi', true);
        }
        if ($type_search !== null) {
        ...
        if (is_array($sub_type_search)) {
            $sub_type_search = ObjectSerializer::serializeCollection($sub_type_search, 'multi', true);
        }
        ...
        if (is_array($store_ids)) {
            $store_ids = ObjectSerializer::serializeCollection($store_ids, 'multi', true);
        }
        if ($store_ids !== null) {
     ...
     *
     * @param  int $voucher_id Id of the voucher (required)
     * @param  \Flipdish\Client\Model\VoucherBase $voucher Updated details for the voucher (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultVoucherWithStats
     */
    public function updateVoucher($voucher_id, $voucher)
    {
        list($response) = $this->updateVoucherWithHttpInfo($voucher_id, $voucher);
        return $response;
    }
     ...
     * @return array of \Flipdish\Client\Model\RestApiResultVoucherWithStats, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVoucherWithHttpInfo($voucher_id, $voucher)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultVoucherWithStats';
        $request = $this->updateVoucherRequest($voucher_id, $voucher);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsync($voucher_id, $voucher)
    {
        return $this->updateVoucherAsyncWithHttpInfo($voucher_id, $voucher)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsyncWithHttpInfo($voucher_id, $voucher)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultVoucherWithStats';
        $request = $this->updateVoucherRequest($voucher_id, $voucher);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateVoucherRequest($voucher_id, $voucher)
    {
        // verify the required parameter 'voucher_id' is set
        if ($voucher_id === null || (is_array($voucher_id) && count($voucher_id) === 0)) {
            throw new \InvalidArgumentException(
