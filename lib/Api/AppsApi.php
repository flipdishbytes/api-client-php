...
class AppsApi
{
     ...
     * @return \Flipdish\Client\Model\RestApiPaginationResultApp
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiPaginationResultApp, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAppsWithHttpInfo($name_filter = null, $page = null, $limit = null)
    {
        $returnType = '\Flipdish\Client\Model\RestApiPaginationResultApp';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiPaginationResultApp',
