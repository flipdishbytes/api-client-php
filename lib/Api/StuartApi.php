...
class StuartApi
{
    ...
    protected function stuartCancelJobRequest($job_id, $store_id)
    {
        ...
        $resourcePath = '/api/v1.0/stuart/jobs/{jobId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultJobResponse
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultJobResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function stuartGetJobWithHttpInfo($job_id, $store_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultJobResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultJobResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultStuartSettings
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultStuartSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function stuartGetStuartSettingsWithHttpInfo($store_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultStuartSettings';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultStuartSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function stuartGetStuartSettingsRequest($store_id)
    {
        ...
        $resourcePath = '/api/v1.0/stuart/settings/{storeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $store_id store_id (required)
     * @param  \Flipdish\Client\Model\StuartSettings $stuart_settings stuart_settings (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  int $store_id (required)
     * @param  \Flipdish\Client\Model\StuartSettings $stuart_settings (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
    ...
    protected function stuartPostStuartSettingsRequest($store_id, $stuart_settings)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($stuart_settings)) {
            $_tempBody = $stuart_settings;
        }
