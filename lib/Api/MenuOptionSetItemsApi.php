...
class MenuOptionSetItemsApi
{
     ...
     * @param  \Flipdish\Client\Model\MenuItemOptionSetItemBase $menu_item_option_set_item Option set item (required)
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultMenuItemOptionSetItem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultMenuItemOptionSetItem
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultMenuItemOptionSetItem, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultMenuItemOptionSetItem';
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSetItem
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSetItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemOptionSetItemsWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSetItem';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSetItem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $option_set_id Option set identifier (required)
     * @param  int $menu_item_option_set_item_id Option set item identifier (required)
     * @param  \Flipdish\Client\Model\MenuItemOptionSetItemBase $menu_item_option_set_item Option set item (delta) (required)
