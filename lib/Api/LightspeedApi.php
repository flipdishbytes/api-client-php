...
class LightspeedApi
{
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultLightspeedSettings
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultLightspeedSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function lightspeedGetStoreSettingsWithHttpInfo($store_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultLightspeedSettings';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultLightspeedSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $store_id store_id (required)
     * @param  \Flipdish\Client\Model\LightspeedSettings $lightspeed_settings lightspeed_settings (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultLightspeedSettings
     ...
     *
     * @param  int $store_id (required)
     * @param  \Flipdish\Client\Model\LightspeedSettings $lightspeed_settings (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultLightspeedSettings, HTTP status code, HTTP response headers (array of strings)
