...
class MenusApi
{
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultMenu
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultMenu, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuByIdWithHttpInfo($menu_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultMenu';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultMenu',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiArrayResultMetadata
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiArrayResultMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemMetadataWithHttpInfo($menu_id, $store_id, $menu_item_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiArrayResultMetadata';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiArrayResultMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultMetadata
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemOptionSetItemMetadataWithHttpInfo($menu_id, $store_id, $option_set_item_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultMetadata';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $store_id Store identifier (required)
     * @param  int $menu_item_id Menu item identifier (required)
     * @param  \Flipdish\Client\Model\Metadata $metadata Metadata object (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $menu_id Menu identifier (required)
     * @param  \Flipdish\Client\Model\MenuBase $menu Menu (delta) (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
