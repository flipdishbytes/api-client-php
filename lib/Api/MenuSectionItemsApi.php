...
class MenuSectionItemsApi
{
     ...
     * @return \Flipdish\Client\Model\RestApiResultMenuSectionItem
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultMenuSectionItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function cloneMenuSectionItemWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultMenuSectionItem';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultMenuSectionItem',
     ...
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  \Flipdish\Client\Model\MenuSectionItemBase $menu_section_item Menu section item (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiArrayResultMenuSectionItem
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiArrayResultMenuSectionItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemsWithHttpInfo($menu_id, $menu_section_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiArrayResultMenuSectionItem';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiArrayResultMenuSectionItem',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  int $menu_section_item_id Menu section item identifier (required)
     * @param  \Flipdish\Client\Model\MenuSectionItemBase $menu_section_item Menu section item (delta) (required)
