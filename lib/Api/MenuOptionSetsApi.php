...
class MenuOptionSetsApi
{
     ...
     * @param  \Flipdish\Client\Model\MenuItemOptionSetBase $menu_item_option_set Menu item option set (required)
     *
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiResultMenuItemOptionSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiResultMenuItemOptionSet
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiResultMenuItemOptionSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemOptionSetByIdWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiResultMenuItemOptionSet';
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSet
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuItemOptionSetsWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id)
    {
        $returnType = '\Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Model\RestApiArrayResultMenuItemOptionSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $menu_section_item_id Menu section item identifier (required)
     * @param  int $option_set_id Option set identifier (required)
     * @param  \Flipdish\Client\Model\MenuItemOptionSetBase $menu_item_option_set Menu item option set (delta) (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
