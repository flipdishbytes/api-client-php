...
class AppsApi
{
     ...
     * @return void
     */
    public function setPropertyId($app_id, $org_id)
    {
        $this->setPropertyIdWithHttpInfo($app_id, $org_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setPropertyIdWithHttpInfo($app_id, $org_id)
    {
        $returnType = '';
        $request = $this->setPropertyIdRequest($app_id, $org_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPropertyIdAsync($app_id, $org_id)
    {
        return $this->setPropertyIdAsyncWithHttpInfo($app_id, $org_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPropertyIdAsyncWithHttpInfo($app_id, $org_id)
    {
        $returnType = '';
        $request = $this->setPropertyIdRequest($app_id, $org_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setPropertyIdRequest($app_id, $org_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling setPropertyId'
            );
        }
        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling setPropertyId'
            );
        }
