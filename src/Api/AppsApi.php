...
class AppsApi
{
     ...
     * @return object
     */
    public function appsSetPropertyId($app_id, $org_id)
    {
        list($response) = $this->appsSetPropertyIdWithHttpInfo($app_id, $org_id);
        return $response;
    }

    /**
     * Operation appsSetPropertyIdWithHttpInfo
     *
     ...
     */
    public function appsSetPropertyIdWithHttpInfo($app_id, $org_id)
    {
        $returnType = 'object';
        $request = $this->appsSetPropertyIdRequest($app_id, $org_id);
    ...
    /**
     * Operation appsSetPropertyIdAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     */
    public function appsSetPropertyIdAsync($app_id, $org_id)
    {
        return $this->appsSetPropertyIdAsyncWithHttpInfo($app_id, $org_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation appsSetPropertyIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function appsSetPropertyIdAsyncWithHttpInfo($app_id, $org_id)
    {
        $returnType = 'object';
        $request = $this->appsSetPropertyIdRequest($app_id, $org_id);
    ...
    /**
     * Create request for operation 'appsSetPropertyId'
     *
     * @param  string $app_id (required)
     * @param  string $org_id (required)
     *
     ...
     */
    protected function appsSetPropertyIdRequest($app_id, $org_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling appsSetPropertyId'
            );
        }
        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling appsSetPropertyId'
            );
        }

        $resourcePath = '/api/v1.0/apps/{appId}/orgId/{orgId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Operation createApp
     *
     * @param  \Flipdish\\Client\Models\CreateAppParameters $parameters parameters (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->createAppWithHttpInfo($parameters);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAppAsync($parameters)
    {
        return $this->createAppAsyncWithHttpInfo($parameters)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAppAsyncWithHttpInfo($parameters)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiStringResult';
        $request = $this->createAppRequest($parameters);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createAppRequest($parameters)
    {
        // verify the required parameter 'parameters' is set
        if ($parameters === null || (is_array($parameters) && count($parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parameters when calling createApp'
            );
        }
    ...
    {
        list($response) = $this->getAppNameWithHttpInfo($app_id);
        return $response;
    }

    /**
     * Operation getAppNameWithHttpInfo
     *
     * @param  string $app_id (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     ...
     * @return array of \Flipdish\\Client\Models\RestApiStringResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAppNameWithHttpInfo($app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiStringResult';
        $request = $this->getAppNameRequest($app_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppNameAsync($app_id)
    {
        return $this->getAppNameAsyncWithHttpInfo($app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAppNameAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppNameAsyncWithHttpInfo($app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiStringResult';
        $request = $this->getAppNameRequest($app_id);
    ...
    /**
     * Create request for operation 'getAppName'
     *
     * @param  string $app_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAppNameRequest($app_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getAppName'
            );
        }

        $resourcePath = '/api/v1.0/apps/{appId}/name';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function sendPushNotification($app_id, $customer_id, $message)
    {
        $this->sendPushNotificationWithHttpInfo($app_id, $customer_id, $message);
    }
     ...
     */
    public function sendPushNotificationWithHttpInfo($app_id, $customer_id, $message)
    {
        $returnType = '';
        $request = $this->sendPushNotificationRequest($app_id, $customer_id, $message);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendPushNotificationAsync($app_id, $customer_id, $message)
    {
        return $this->sendPushNotificationAsyncWithHttpInfo($app_id, $customer_id, $message)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendPushNotificationAsyncWithHttpInfo($app_id, $customer_id, $message)
    {
        $returnType = '';
        $request = $this->sendPushNotificationRequest($app_id, $customer_id, $message);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendPushNotificationRequest($app_id, $customer_id, $message)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling sendPushNotification'
            );
        }
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling sendPushNotification'
            );
        }
        // verify the required parameter 'message' is set
        if ($message === null || (is_array($message) && count($message) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $message when calling sendPushNotification'
            );
        }

        $resourcePath = '/api/v1.0/apps/{appId}/SendPushNotification/{customerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation setThirdPartyIntegrations
     *
     * @param  string $app_id app_id (required)
     ...
     * @return void
     */
    public function setThirdPartyIntegrations($app_id, $enabled)
    {
        $this->setThirdPartyIntegrationsWithHttpInfo($app_id, $enabled);
    }

    /**
     * Operation setThirdPartyIntegrationsWithHttpInfo
     *
     * @param  string $app_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setThirdPartyIntegrationsWithHttpInfo($app_id, $enabled)
    {
        $returnType = '';
        $request = $this->setThirdPartyIntegrationsRequest($app_id, $enabled);
    ...
    /**
     * Operation setThirdPartyIntegrationsAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setThirdPartyIntegrationsAsync($app_id, $enabled)
    {
        return $this->setThirdPartyIntegrationsAsyncWithHttpInfo($app_id, $enabled)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setThirdPartyIntegrationsAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setThirdPartyIntegrationsAsyncWithHttpInfo($app_id, $enabled)
    {
        $returnType = '';
        $request = $this->setThirdPartyIntegrationsRequest($app_id, $enabled);
    ...
    /**
     * Create request for operation 'setThirdPartyIntegrations'
     *
     * @param  string $app_id (required)
     * @param  bool $enabled (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setThirdPartyIntegrationsRequest($app_id, $enabled)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling setThirdPartyIntegrations'
            );
        }
        // verify the required parameter 'enabled' is set
        if ($enabled === null || (is_array($enabled) && count($enabled) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $enabled when calling setThirdPartyIntegrations'
            );
        }

        $resourcePath = '/api/v1.0/apps/{appId}/third-party-integrations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
