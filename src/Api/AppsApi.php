...
class AppsApi
{
    ...
    /**
     * Operation createAppInOrg
     *
     * @param  string $org_id org_id (required)
     * @param  \Flipdish\\Client\Models\CreateAppInOrg $create_app_in_org_request create_app_in_org_request (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultApp
     */
    public function createAppInOrg($org_id, $create_app_in_org_request)
    {
        list($response) = $this->createAppInOrgWithHttpInfo($org_id, $create_app_in_org_request);
        return $response;
    }

    /**
     * Operation createAppInOrgWithHttpInfo
     *
     * @param  string $org_id (required)
     * @param  \Flipdish\\Client\Models\CreateAppInOrg $create_app_in_org_request (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultApp, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAppInOrgWithHttpInfo($org_id, $create_app_in_org_request)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultApp';
        $request = $this->createAppInOrgRequest($org_id, $create_app_in_org_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAppInOrgAsync($org_id, $create_app_in_org_request)
    {
        return $this->createAppInOrgAsyncWithHttpInfo($org_id, $create_app_in_org_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createAppInOrgAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $org_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAppInOrgAsyncWithHttpInfo($org_id, $create_app_in_org_request)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultApp';
        $request = $this->createAppInOrgRequest($org_id, $create_app_in_org_request);
    ...
    /**
     * Create request for operation 'createAppInOrg'
     *
     * @param  string $org_id (required)
     * @param  \Flipdish\\Client\Models\CreateAppInOrg $create_app_in_org_request (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createAppInOrgRequest($org_id, $create_app_in_org_request)
    {
        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling createAppInOrg'
            );
        }
        // verify the required parameter 'create_app_in_org_request' is set
        if ($create_app_in_org_request === null || (is_array($create_app_in_org_request) && count($create_app_in_org_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_app_in_org_request when calling createAppInOrg'
            );
        }

        $resourcePath = '/api/v1.0/orgs/{orgId}/apps';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($create_app_in_org_request)) {
            $_tempBody = $create_app_in_org_request;
        }
