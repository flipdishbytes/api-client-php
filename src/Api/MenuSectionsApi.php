...
class MenuSectionsApi
{
     ...
     * @return \Flipdish\\Client\Models\RestApiResultMenuSection
     */
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultMenuSection, HTTP status code, HTTP response headers (array of strings)
     */
    public function cloneMenuSectionWithHttpInfo($menu_id, $menu_section_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultMenuSection';
     ...
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  string $day_of_week Day of the  week (required)
     * @param  \Flipdish\\Client\Models\BusinessHoursPeriodBase $business_hours_period Menu section active hours, note: DayOfWeek property will be overriden by the path parameter. (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  int $menu_id Menu identifier (required)
     * @param  \Flipdish\\Client\Models\MenuSectionBase $menu_section Menu section (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  \Flipdish\\Client\Models\MenuSectionAvailabilityBase $menu_section_availability DisplayAlways, DisplayBasedOnTimes, DisplayAlwaysStartCollapsed, DisplayAlwaysStartCollapsedBasedOnTimes (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultMenuSectionAvailability',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiArrayResultMenuSection
     */
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiArrayResultMenuSection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMenuSectionsWithHttpInfo($menu_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultMenuSection';
     ...
     * @return void
     */
    public function setItemDisplayOrders($menu_id, $menu_section_id, $display_orders)
    {
        $this->setItemDisplayOrdersWithHttpInfo($menu_id, $menu_section_id, $display_orders);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setItemDisplayOrdersWithHttpInfo($menu_id, $menu_section_id, $display_orders)
    {
        $returnType = '';
        $request = $this->setItemDisplayOrdersRequest($menu_id, $menu_section_id, $display_orders);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setItemDisplayOrdersAsync($menu_id, $menu_section_id, $display_orders)
    {
        return $this->setItemDisplayOrdersAsyncWithHttpInfo($menu_id, $menu_section_id, $display_orders)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setItemDisplayOrdersAsyncWithHttpInfo($menu_id, $menu_section_id, $display_orders)
    {
        $returnType = '';
        $request = $this->setItemDisplayOrdersRequest($menu_id, $menu_section_id, $display_orders);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setItemDisplayOrdersRequest($menu_id, $menu_section_id, $display_orders)
    {
        // verify the required parameter 'menu_id' is set
        if ($menu_id === null || (is_array($menu_id) && count($menu_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($menu_section_id === null || (is_array($menu_section_id) && count($menu_section_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_section_id when calling setItemDisplayOrders'
            );
        }
        ...
        $resourcePath = '/api/v1.0/menus/{menuId}/sections/{menuSectionId}/sectionitemdisplayorders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  \Flipdish\\Client\Models\MenuSectionBase $menu_section Menu section changes (delta) (required)
