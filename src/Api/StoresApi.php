...
class StoresApi
{
     ...
     * @param  string $search_query search_query (optional)
     * @param  string $sales_channel_type sales_channel_type (optional)
     * @param  bool $exclude_unpublished exclude_unpublished (optional)
     * @param  int $page page (optional)
     * @param  int $limit limit (optional)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     ...
     * @return \Flipdish\\Client\Models\RestApiPaginationResultStore
     */
    public function getStoresByAppId($app_id, $search_query = null, $sales_channel_type = null, $exclude_unpublished = null, $page = null, $limit = null)
    {
        list($response) = $this->getStoresByAppIdWithHttpInfo($app_id, $search_query, $sales_channel_type, $exclude_unpublished, $page, $limit);
        return $response;
    }
     ...
     * @param  string $search_query (optional)
     * @param  string $sales_channel_type (optional)
     * @param  bool $exclude_unpublished (optional)
     * @param  int $page (optional)
     * @param  int $limit (optional)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     ...
     * @return array of \Flipdish\\Client\Models\RestApiPaginationResultStore, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStoresByAppIdWithHttpInfo($app_id, $search_query = null, $sales_channel_type = null, $exclude_unpublished = null, $page = null, $limit = null)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiPaginationResultStore';
        $request = $this->getStoresByAppIdRequest($app_id, $search_query, $sales_channel_type, $exclude_unpublished, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoresByAppIdAsync($app_id, $search_query = null, $sales_channel_type = null, $exclude_unpublished = null, $page = null, $limit = null)
    {
        return $this->getStoresByAppIdAsyncWithHttpInfo($app_id, $search_query, $sales_channel_type, $exclude_unpublished, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStoresByAppIdAsyncWithHttpInfo($app_id, $search_query = null, $sales_channel_type = null, $exclude_unpublished = null, $page = null, $limit = null)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiPaginationResultStore';
        $request = $this->getStoresByAppIdRequest($app_id, $search_query, $sales_channel_type, $exclude_unpublished, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStoresByAppIdRequest($app_id, $search_query = null, $sales_channel_type = null, $exclude_unpublished = null, $page = null, $limit = null)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($exclude_unpublished !== null) {
            $queryParams['excludeUnpublished'] = ObjectSerializer::toQueryValue($exclude_unpublished);
        }
        // query params
        if ($page !== null) {
            $queryParams['page'] = ObjectSerializer::toQueryValue($page);
    ...
    /**
     * Operation setStoreCollectionSettings
     *
     * @param  int $store_id store_id (required)
    ...
    /**
     * Operation setStoreCollectionSettingsWithHttpInfo
     *
     * @param  int $store_id (required)
    ...
    /**
     * Operation setStoreCollectionSettingsAsync
     *
     * 
     *
     * @param  int $store_id (required)
    ...
    /**
     * Operation setStoreCollectionSettingsAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $store_id (required)
    ...
    /**
     * Create request for operation 'setStoreCollectionSettings'
     *
     * @param  int $store_id (required)
     * @param  \Flipdish\\Client\Models\StoreCollectionSettings $settings (required)
     * @param  bool $inherit_from_property (optional)
    ...
    protected function setStoreCollectionSettingsRequest($store_id, $settings, $inherit_from_property = null)
    {
        ...
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling setStoreCollectionSettings'
            );
        }
        // verify the required parameter 'settings' is set
        if ($settings === null || (is_array($settings) && count($settings) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $settings when calling setStoreCollectionSettings'
            );
        }

        $resourcePath = '/api/v1.0/stores/{storeId}/collectionsettings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object
     */
    public function storesSetPropertyId($store_id, $property_id)
    {
        list($response) = $this->storesSetPropertyIdWithHttpInfo($store_id, $property_id);
        return $response;
    }

    /**
     * Operation storesSetPropertyIdWithHttpInfo
     *
     * @param  int $store_id (required)
     * @param  string $property_id (required)
     *
     ...
     */
    public function storesSetPropertyIdWithHttpInfo($store_id, $property_id)
    {
        $returnType = 'object';
        $request = $this->storesSetPropertyIdRequest($store_id, $property_id);
    ...
    /**
     * Operation storesSetPropertyIdAsync
     *
     * 
     *
     * @param  int $store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storesSetPropertyIdAsync($store_id, $property_id)
    {
        return $this->storesSetPropertyIdAsyncWithHttpInfo($store_id, $property_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation storesSetPropertyIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storesSetPropertyIdAsyncWithHttpInfo($store_id, $property_id)
    {
        $returnType = 'object';
        $request = $this->storesSetPropertyIdRequest($store_id, $property_id);
    ...
    /**
     * Create request for operation 'storesSetPropertyId'
     *
     * @param  int $store_id (required)
     * @param  string $property_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function storesSetPropertyIdRequest($store_id, $property_id)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling storesSetPropertyId'
            );
        }
        // verify the required parameter 'property_id' is set
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_id when calling storesSetPropertyId'
            );
        }

        $resourcePath = '/api/v1.0/stores/{storeId}/propertyId/{propertyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation supportedSalesChannelsTypes
     *
     * @param  string $property_id property_id (required)
     * @param  int $store_id store_id (required)
     * @param  string[] $sales_channel_types sales_channel_types (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function supportedSalesChannelsTypes($property_id, $store_id, $sales_channel_types)
    {
        $this->supportedSalesChannelsTypesWithHttpInfo($property_id, $store_id, $sales_channel_types);
    }

    /**
     * Operation supportedSalesChannelsTypesWithHttpInfo
     *
     * @param  string $property_id (required)
     * @param  int $store_id (required)
     * @param  string[] $sales_channel_types (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function supportedSalesChannelsTypesWithHttpInfo($property_id, $store_id, $sales_channel_types)
    {
        $returnType = '';
        $request = $this->supportedSalesChannelsTypesRequest($property_id, $store_id, $sales_channel_types);
    ...
    /**
     * Operation supportedSalesChannelsTypesAsync
     *
     * 
     *
     * @param  string $property_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function supportedSalesChannelsTypesAsync($property_id, $store_id, $sales_channel_types)
    {
        return $this->supportedSalesChannelsTypesAsyncWithHttpInfo($property_id, $store_id, $sales_channel_types)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation supportedSalesChannelsTypesAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $property_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function supportedSalesChannelsTypesAsyncWithHttpInfo($property_id, $store_id, $sales_channel_types)
    {
        $returnType = '';
        $request = $this->supportedSalesChannelsTypesRequest($property_id, $store_id, $sales_channel_types);
    ...
    /**
     * Create request for operation 'supportedSalesChannelsTypes'
     *
     * @param  string $property_id (required)
     * @param  int $store_id (required)
     * @param  string[] $sales_channel_types (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function supportedSalesChannelsTypesRequest($property_id, $store_id, $sales_channel_types)
    {
        // verify the required parameter 'property_id' is set
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_id when calling supportedSalesChannelsTypes'
            );
        }
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling supportedSalesChannelsTypes'
            );
        }
        // verify the required parameter 'sales_channel_types' is set
        if ($sales_channel_types === null || (is_array($sales_channel_types) && count($sales_channel_types) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sales_channel_types when calling supportedSalesChannelsTypes'
            );
        }

        $resourcePath = '/api/v1.0/properties/{propertyId}/stores/{storeId}/supportedSalesChannels';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($sales_channel_types)) {
            $_tempBody = $sales_channel_types;
        }
