...
class StoresApi
{
     ...
     * @return void
     */
    public function setPropertyId($store_id, $property_id)
    {
        $this->setPropertyIdWithHttpInfo($store_id, $property_id);
    }

    /**
     * Operation setPropertyIdWithHttpInfo
     *
     * @param  int $store_id (required)
     * @param  string $property_id (required)
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setPropertyIdWithHttpInfo($store_id, $property_id)
    {
        $returnType = '';
        $request = $this->setPropertyIdRequest($store_id, $property_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPropertyIdAsync($store_id, $property_id)
    {
        return $this->setPropertyIdAsyncWithHttpInfo($store_id, $property_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setPropertyIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPropertyIdAsyncWithHttpInfo($store_id, $property_id)
    {
        $returnType = '';
        $request = $this->setPropertyIdRequest($store_id, $property_id);
    ...
    /**
     * Create request for operation 'setPropertyId'
     *
     * @param  int $store_id (required)
     * @param  string $property_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setPropertyIdRequest($store_id, $property_id)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling setPropertyId'
            );
        }
        // verify the required parameter 'property_id' is set
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_id when calling setPropertyId'
            );
        }
    ...
    {
        $this->updateStoreAddressFormWithHttpInfo($store_id, $address);
    }
