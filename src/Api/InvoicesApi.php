...
class InvoicesApi
{
     ...
     * @return void
     */
    public function invoicePdf($invoice_number, $app_id)
    {
        $this->invoicePdfWithHttpInfo($invoice_number, $app_id);
    }
     ...
     */
    public function invoicePdfWithHttpInfo($invoice_number, $app_id)
    {
        $returnType = '';
        $request = $this->invoicePdfRequest($invoice_number, $app_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicePdfAsync($invoice_number, $app_id)
    {
        return $this->invoicePdfAsyncWithHttpInfo($invoice_number, $app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicePdfAsyncWithHttpInfo($invoice_number, $app_id)
    {
        $returnType = '';
        $request = $this->invoicePdfRequest($invoice_number, $app_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function invoicePdfRequest($invoice_number, $app_id)
    {
        // verify the required parameter 'invoice_number' is set
        if ($invoice_number === null || (is_array($invoice_number) && count($invoice_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invoice_number when calling invoicePdf'
            );
        }
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling invoicePdf'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/invoices/InvoicePdf';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listInvoicesRequest($store_id, $app_id, $limit = null, $page = null)
    {
        ...
        $resourcePath = '/api/v1.0/{appId}/invoices/ListInvoices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->listSubscriptionInvoicesWithHttpInfo($app_id, $subscription_id, $limit, $page_id, $exclude_not_owned_invoices, $date_from, $date_to, $invoice_number, $store_id);
        return $response;
    }

    /**
     * Operation listSubscriptionInvoicesWithHttpInfo
     *
     * @param  string $app_id (required)
     * @param  string $subscription_id (optional)
     * @param  int $limit (optional)
    ...
    /**
     * Operation listSubscriptionInvoicesAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSubscriptionInvoicesAsync($app_id, $subscription_id = null, $limit = null, $page_id = null, $exclude_not_owned_invoices = null, $date_from = null, $date_to = null, $invoice_number = null, $store_id = null)
    {
        return $this->listSubscriptionInvoicesAsyncWithHttpInfo($app_id, $subscription_id, $limit, $page_id, $exclude_not_owned_invoices, $date_from, $date_to, $invoice_number, $store_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listSubscriptionInvoicesAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
    ...
    /**
     * Create request for operation 'listSubscriptionInvoices'
     *
     * @param  string $app_id (required)
     * @param  string $subscription_id (optional)
     * @param  int $limit (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listSubscriptionInvoicesRequest($app_id, $subscription_id = null, $limit = null, $page_id = null, $exclude_not_owned_invoices = null, $date_from = null, $date_to = null, $invoice_number = null, $store_id = null)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling listSubscriptionInvoices'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/invoices/ListSubscriptionInvoices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
