...
class MenusApi
{
     ...
     * @param  bool $hide hide (required)
     * @param  double $undo_after undo_after (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Models\RestApiArrayResultMenuElementEditResponse
     */
    public function menusShowHideBulkItems($menu_id, $menu_elements, $hide, $undo_after)
    {
        list($response) = $this->menusShowHideBulkItemsWithHttpInfo($menu_id, $menu_elements, $hide, $undo_after);
        return $response;
    }
     ...
     * @param  bool $hide (required)
     * @param  double $undo_after (required)
     *
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function menusShowHideBulkItemsWithHttpInfo($menu_id, $menu_elements, $hide, $undo_after)
    {
        $returnType = '\Flipdish\Client\Models\RestApiArrayResultMenuElementEditResponse';
        $request = $this->menusShowHideBulkItemsRequest($menu_id, $menu_elements, $hide, $undo_after);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function menusShowHideBulkItemsAsync($menu_id, $menu_elements, $hide, $undo_after)
    {
        return $this->menusShowHideBulkItemsAsyncWithHttpInfo($menu_id, $menu_elements, $hide, $undo_after)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function menusShowHideBulkItemsAsyncWithHttpInfo($menu_id, $menu_elements, $hide, $undo_after)
    {
        $returnType = '\Flipdish\Client\Models\RestApiArrayResultMenuElementEditResponse';
        $request = $this->menusShowHideBulkItemsRequest($menu_id, $menu_elements, $hide, $undo_after);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function menusShowHideBulkItemsRequest($menu_id, $menu_elements, $hide, $undo_after)
    {
        // verify the required parameter 'menu_id' is set
        if ($menu_id === null || (is_array($menu_id) && count($menu_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($hide === null || (is_array($hide) && count($hide) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hide when calling menusShowHideBulkItems'
            );
        }
        // verify the required parameter 'undo_after' is set
        if ($undo_after === null || (is_array($undo_after) && count($undo_after) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $undo_after when calling menusShowHideBulkItems'
            );
        }
