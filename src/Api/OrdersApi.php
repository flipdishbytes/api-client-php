...
class OrdersApi
{
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatus
     */
    public function getFulfillmentState($order_id)
    {
        list($response) = $this->getFulfillmentStateWithHttpInfo($order_id);
        return $response;
    }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFulfillmentStateWithHttpInfo($order_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatus';
        $request = $this->getFulfillmentStateRequest($order_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFulfillmentStateAsync($order_id)
    {
        return $this->getFulfillmentStateAsyncWithHttpInfo($order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFulfillmentStateAsyncWithHttpInfo($order_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatus';
        $request = $this->getFulfillmentStateRequest($order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFulfillmentStateRequest($order_id)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getFulfillmentState'
            );
        }

        $resourcePath = '/api/v1.0/orders/{orderId}/fulfillment/state';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatusWithConfigurationActions
     */
    public function getFulfillmentStatusWithDetailsAndActions($order_id)
    {
        list($response) = $this->getFulfillmentStatusWithDetailsAndActionsWithHttpInfo($order_id);
        return $response;
    }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatusWithConfigurationActions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFulfillmentStatusWithDetailsAndActionsWithHttpInfo($order_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatusWithConfigurationActions';
        $request = $this->getFulfillmentStatusWithDetailsAndActionsRequest($order_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatusWithConfigurationActions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFulfillmentStatusWithDetailsAndActionsAsync($order_id)
    {
        return $this->getFulfillmentStatusWithDetailsAndActionsAsyncWithHttpInfo($order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFulfillmentStatusWithDetailsAndActionsAsyncWithHttpInfo($order_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultOrderFulfillmentStatusWithConfigurationActions';
        $request = $this->getFulfillmentStatusWithDetailsAndActionsRequest($order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFulfillmentStatusWithDetailsAndActionsRequest($order_id)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getFulfillmentStatusWithDetailsAndActions'
            );
        }

        $resourcePath = '/api/v1.0/orders/{orderId}/fulfillment/state/details';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\OrderList
     */
    public function getReadyToProcess($app_id, $store_id = null)
    {
        list($response) = $this->getReadyToProcessWithHttpInfo($app_id, $store_id);
        return $response;
    }

    /**
     * Operation getReadyToProcessWithHttpInfo
     *
     * @param  string $app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\OrderList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReadyToProcessWithHttpInfo($app_id, $store_id = null)
    {
        $returnType = '\Flipdish\\Client\Models\OrderList';
        $request = $this->getReadyToProcessRequest($app_id, $store_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\OrderList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getReadyToProcessAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReadyToProcessAsync($app_id, $store_id = null)
    {
        return $this->getReadyToProcessAsyncWithHttpInfo($app_id, $store_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getReadyToProcessAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReadyToProcessAsyncWithHttpInfo($app_id, $store_id = null)
    {
        $returnType = '\Flipdish\\Client\Models\OrderList';
        $request = $this->getReadyToProcessRequest($app_id, $store_id);
    ...
    /**
     * Create request for operation 'getReadyToProcess'
     *
     * @param  string $app_id (required)
     * @param  int[] $store_id (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getReadyToProcessRequest($app_id, $store_id = null)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getReadyToProcess'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/orders/ready_to_process';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiArrayResultOrderFulfillmentStatus
     */
    public function searchFulfillmentStatuses($app_id, $order_ids)
    {
        list($response) = $this->searchFulfillmentStatusesWithHttpInfo($app_id, $order_ids);
        return $response;
    }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiArrayResultOrderFulfillmentStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchFulfillmentStatusesWithHttpInfo($app_id, $order_ids)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultOrderFulfillmentStatus';
        $request = $this->searchFulfillmentStatusesRequest($app_id, $order_ids);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiArrayResultOrderFulfillmentStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFulfillmentStatusesAsync($app_id, $order_ids)
    {
        return $this->searchFulfillmentStatusesAsyncWithHttpInfo($app_id, $order_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFulfillmentStatusesAsyncWithHttpInfo($app_id, $order_ids)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultOrderFulfillmentStatus';
        $request = $this->searchFulfillmentStatusesRequest($app_id, $order_ids);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchFulfillmentStatusesRequest($app_id, $order_ids)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling searchFulfillmentStatuses'
            );
        }
        // verify the required parameter 'order_ids' is set
        if ($order_ids === null || (is_array($order_ids) && count($order_ids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_ids when calling searchFulfillmentStatuses'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/orders/fulfillmentstatuses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function updateFulfillmentState($order_id, $fulfillment_status_request)
    {
        $this->updateFulfillmentStateWithHttpInfo($order_id, $fulfillment_status_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFulfillmentStateWithHttpInfo($order_id, $fulfillment_status_request)
    {
        $returnType = '';
        $request = $this->updateFulfillmentStateRequest($order_id, $fulfillment_status_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFulfillmentStateAsync($order_id, $fulfillment_status_request)
    {
        return $this->updateFulfillmentStateAsyncWithHttpInfo($order_id, $fulfillment_status_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFulfillmentStateAsyncWithHttpInfo($order_id, $fulfillment_status_request)
    {
        $returnType = '';
        $request = $this->updateFulfillmentStateRequest($order_id, $fulfillment_status_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFulfillmentStateRequest($order_id, $fulfillment_status_request)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling updateFulfillmentState'
            );
        }
        // verify the required parameter 'fulfillment_status_request' is set
        if ($fulfillment_status_request === null || (is_array($fulfillment_status_request) && count($fulfillment_status_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fulfillment_status_request when calling updateFulfillmentState'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($fulfillment_status_request)) {
            $_tempBody = $fulfillment_status_request;
        }
