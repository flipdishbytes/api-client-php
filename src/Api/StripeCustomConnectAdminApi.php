...
/**
 * StripeCustomConnectAdminApi Class Doc Comment
 *
 * @category Class
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StripeCustomConnectAdminApi
{
    /**
     * @var ClientInterface
     */
     ...
     */
    public function initializeBankAccountConnectedAccount($accounts)
    {
        list($response) = $this->initializeBankAccountConnectedAccountWithHttpInfo($accounts);
        return $response;
    }
     ...
     */
    public function initializeBankAccountConnectedAccountWithHttpInfo($accounts)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultBankAccountDetail';
        $request = $this->initializeBankAccountConnectedAccountRequest($accounts);
     ...
     */
    public function initializeBankAccountConnectedAccountAsync($accounts)
    {
        return $this->initializeBankAccountConnectedAccountAsyncWithHttpInfo($accounts)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function initializeBankAccountConnectedAccountAsyncWithHttpInfo($accounts)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultBankAccountDetail';
        $request = $this->initializeBankAccountConnectedAccountRequest($accounts);
     ...
     */
    protected function initializeBankAccountConnectedAccountRequest($accounts)
    {
        // verify the required parameter 'accounts' is set
        if ($accounts === null || (is_array($accounts) && count($accounts) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accounts when calling initializeBankAccountConnectedAccount'
            );
        }

        $resourcePath = '/api/v1.0/customconnect/initialize-bank-account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
