...
class CampaignsApi
{
    ...
    /**
     * Operation fetchLoyaltyCampaignByPublicId
     *
     * @param  string $app_id app_id (required)
     * @param  string $campaign_public_id campaign_public_id (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiArrayResultLoyaltyCampaign
     */
    public function fetchLoyaltyCampaignByPublicId($app_id, $campaign_public_id)
    {
        list($response) = $this->fetchLoyaltyCampaignByPublicIdWithHttpInfo($app_id, $campaign_public_id);
        return $response;
    }

    /**
     * Operation fetchLoyaltyCampaignByPublicIdWithHttpInfo
     *
     * @param  string $app_id (required)
     * @param  string $campaign_public_id (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function fetchLoyaltyCampaignByPublicIdWithHttpInfo($app_id, $campaign_public_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultLoyaltyCampaign';
        $request = $this->fetchLoyaltyCampaignByPublicIdRequest($app_id, $campaign_public_id);
    ...
    /**
     * Operation fetchLoyaltyCampaignByPublicIdAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchLoyaltyCampaignByPublicIdAsync($app_id, $campaign_public_id)
    {
        return $this->fetchLoyaltyCampaignByPublicIdAsyncWithHttpInfo($app_id, $campaign_public_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fetchLoyaltyCampaignByPublicIdAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fetchLoyaltyCampaignByPublicIdAsyncWithHttpInfo($app_id, $campaign_public_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultLoyaltyCampaign';
        $request = $this->fetchLoyaltyCampaignByPublicIdRequest($app_id, $campaign_public_id);
    ...
    /**
     * Create request for operation 'fetchLoyaltyCampaignByPublicId'
     *
     * @param  string $app_id (required)
     * @param  string $campaign_public_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function fetchLoyaltyCampaignByPublicIdRequest($app_id, $campaign_public_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling fetchLoyaltyCampaignByPublicId'
            );
        }
        // verify the required parameter 'campaign_public_id' is set
        if ($campaign_public_id === null || (is_array($campaign_public_id) && count($campaign_public_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_public_id when calling fetchLoyaltyCampaignByPublicId'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/campaigns/loyalty/publicId/{campaignPublicId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($campaign_public_id !== null) {
            $resourcePath = str_replace(
                '{' . 'campaignPublicId' . '}',
                ObjectSerializer::toPathValue($campaign_public_id),
                $resourcePath
            );
        }
