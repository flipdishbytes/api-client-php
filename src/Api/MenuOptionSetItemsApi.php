...
class MenuOptionSetItemsApi
{
     ...
     * @return void
     */
    public function setOptionSetItemTax($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
    {
        $this->setOptionSetItemTaxWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setOptionSetItemTaxWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
    {
        $returnType = '';
        $request = $this->setOptionSetItemTaxRequest($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setOptionSetItemTaxAsync($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
    {
        return $this->setOptionSetItemTaxAsyncWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setOptionSetItemTaxAsyncWithHttpInfo($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
    {
        $returnType = '';
        $request = $this->setOptionSetItemTaxRequest($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setOptionSetItemTaxRequest($menu_id, $menu_section_id, $menu_section_item_id, $option_set_id, $menu_item_option_set_item_id, $tax_rate_id)
    {
        // verify the required parameter 'menu_id' is set
        if ($menu_id === null || (is_array($menu_id) && count($menu_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_id when calling setOptionSetItemTax'
            );
        }
        // verify the required parameter 'menu_section_id' is set
        if ($menu_section_id === null || (is_array($menu_section_id) && count($menu_section_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_section_id when calling setOptionSetItemTax'
            );
        }
        // verify the required parameter 'menu_section_item_id' is set
        if ($menu_section_item_id === null || (is_array($menu_section_item_id) && count($menu_section_item_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_section_item_id when calling setOptionSetItemTax'
            );
        }
        // verify the required parameter 'option_set_id' is set
        if ($option_set_id === null || (is_array($option_set_id) && count($option_set_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $option_set_id when calling setOptionSetItemTax'
            );
        }
        // verify the required parameter 'menu_item_option_set_item_id' is set
        if ($menu_item_option_set_item_id === null || (is_array($menu_item_option_set_item_id) && count($menu_item_option_set_item_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_item_option_set_item_id when calling setOptionSetItemTax'
            );
        }
        // verify the required parameter 'tax_rate_id' is set
        if ($tax_rate_id === null || (is_array($tax_rate_id) && count($tax_rate_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax_rate_id when calling setOptionSetItemTax'
            );
        }

        $resourcePath = '/api/v1.0/menus/{menuId}/sections/{menuSectionId}/sectionitems/{menuSectionItemId}/optionsets/{optionSetId}/optionsetitems/{menuItemOptionSetItemId}/taxrate/{taxRateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
