...
class LocationApi
{
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\LocationAreaLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLocationWithHttpInfo($update_location_input, $location_area_id, $location_id, $app_id, $store_id)
    {
        $returnType = '\Flipdish\\Client\Models\LocationAreaLocation';
