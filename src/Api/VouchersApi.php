...
class VouchersApi
{
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultVoucher
     */
    public function getVoucherByCode($app_id, $code)
    {
        list($response) = $this->getVoucherByCodeWithHttpInfo($app_id, $code);
        return $response;
    }

    /**
     * Operation getVoucherByCodeWithHttpInfo
     *
     * @param  string $app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultVoucher, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVoucherByCodeWithHttpInfo($app_id, $code)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultVoucher';
        $request = $this->getVoucherByCodeRequest($app_id, $code);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultVoucher',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getVoucherByCodeAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherByCodeAsync($app_id, $code)
    {
        return $this->getVoucherByCodeAsyncWithHttpInfo($app_id, $code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVoucherByCodeAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherByCodeAsyncWithHttpInfo($app_id, $code)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultVoucher';
        $request = $this->getVoucherByCodeRequest($app_id, $code);
    ...
    /**
     * Create request for operation 'getVoucherByCode'
     *
     * @param  string $app_id (required)
     * @param  string $code (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVoucherByCodeRequest($app_id, $code)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getVoucherByCode'
            );
        }
        // verify the required parameter 'code' is set
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $code when calling getVoucherByCode'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/vouchers/code/{code}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getVouchersByCustomerForApp
     *
     * @param  string $app_id app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiArrayResultVoucherSummary
     */
    public function getVouchersByCustomerForApp($app_id, $customer_id)
    {
        list($response) = $this->getVouchersByCustomerForAppWithHttpInfo($app_id, $customer_id);
        return $response;
    }

    /**
     * Operation getVouchersByCustomerForAppWithHttpInfo
     *
     * @param  string $app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiArrayResultVoucherSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVouchersByCustomerForAppWithHttpInfo($app_id, $customer_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultVoucherSummary';
        $request = $this->getVouchersByCustomerForAppRequest($app_id, $customer_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiArrayResultVoucherSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getVouchersByCustomerForAppAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersByCustomerForAppAsync($app_id, $customer_id)
    {
        return $this->getVouchersByCustomerForAppAsyncWithHttpInfo($app_id, $customer_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVouchersByCustomerForAppAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersByCustomerForAppAsyncWithHttpInfo($app_id, $customer_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultVoucherSummary';
        $request = $this->getVouchersByCustomerForAppRequest($app_id, $customer_id);
    ...
    /**
     * Create request for operation 'getVouchersByCustomerForApp'
     *
     * @param  string $app_id (required)
     * @param  int $customer_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVouchersByCustomerForAppRequest($app_id, $customer_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getVouchersByCustomerForApp'
            );
        }
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling getVouchersByCustomerForApp'
            );
        }

        $resourcePath = '/api/v1.0/vouchers/{appId}/customer/{customerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
