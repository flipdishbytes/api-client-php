...
class StripeCustomConnectApi
{
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiArrayResultStripeCustomConnectedAccount
     */
    public function getCustomConnect($store_id, $app_id)
    {
        list($response) = $this->getCustomConnectWithHttpInfo($store_id, $app_id);
        return $response;
    }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiArrayResultStripeCustomConnectedAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomConnectWithHttpInfo($store_id, $app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultStripeCustomConnectedAccount';
        $request = $this->getCustomConnectRequest($store_id, $app_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiArrayResultStripeCustomConnectedAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomConnectAsync($store_id, $app_id)
    {
        return $this->getCustomConnectAsyncWithHttpInfo($store_id, $app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomConnectAsyncWithHttpInfo($store_id, $app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultStripeCustomConnectedAccount';
        $request = $this->getCustomConnectRequest($store_id, $app_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomConnectRequest($store_id, $app_id)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $store_id when calling getCustomConnect'
            );
        }
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getCustomConnect'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/customconnect/{storeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object
     */
    public function refresh($link_request_id, $app_id)
    {
        list($response) = $this->refreshWithHttpInfo($link_request_id, $app_id);
        return $response;
    }
     ...
     */
    public function refreshWithHttpInfo($link_request_id, $app_id)
    {
        $returnType = 'object';
        $request = $this->refreshRequest($link_request_id, $app_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshAsync($link_request_id, $app_id)
    {
        return $this->refreshAsyncWithHttpInfo($link_request_id, $app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshAsyncWithHttpInfo($link_request_id, $app_id)
    {
        $returnType = 'object';
        $request = $this->refreshRequest($link_request_id, $app_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function refreshRequest($link_request_id, $app_id)
    {
        ...
        if ($link_request_id === null || (is_array($link_request_id) && count($link_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link_request_id when calling refresh'
            );
        }
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling refresh'
            );
        }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultModelBase
     */
    public function updatePayoutSchedule($app_id, $stripe_connected_account_id, $interval)
    {
        list($response) = $this->updatePayoutScheduleWithHttpInfo($app_id, $stripe_connected_account_id, $interval);
        return $response;
    }
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultModelBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePayoutScheduleWithHttpInfo($app_id, $stripe_connected_account_id, $interval)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultModelBase';
        $request = $this->updatePayoutScheduleRequest($app_id, $stripe_connected_account_id, $interval);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultModelBase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePayoutScheduleAsync($app_id, $stripe_connected_account_id, $interval)
    {
        return $this->updatePayoutScheduleAsyncWithHttpInfo($app_id, $stripe_connected_account_id, $interval)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePayoutScheduleAsyncWithHttpInfo($app_id, $stripe_connected_account_id, $interval)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultModelBase';
        $request = $this->updatePayoutScheduleRequest($app_id, $stripe_connected_account_id, $interval);
    ...
    /**
     * Create request for operation 'updatePayoutSchedule'
     *
     * @param  string $app_id (required)
     * @param  string $stripe_connected_account_id (required)
     * @param  string $interval (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePayoutScheduleRequest($app_id, $stripe_connected_account_id, $interval)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling updatePayoutSchedule'
            );
        }
        // verify the required parameter 'stripe_connected_account_id' is set
        if ($stripe_connected_account_id === null || (is_array($stripe_connected_account_id) && count($stripe_connected_account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $stripe_connected_account_id when calling updatePayoutSchedule'
            );
        }
        // verify the required parameter 'interval' is set
        if ($interval === null || (is_array($interval) && count($interval) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $interval when calling updatePayoutSchedule'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/customconnect/update-payout-schedule/{stripeConnectedAccountId}/{interval}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
