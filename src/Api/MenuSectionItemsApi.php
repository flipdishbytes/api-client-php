...
class MenuSectionItemsApi
{
    ...
    /**
     * Operation createMenuSectionItemFromProducts
     *
     * Create menu section items from a list of Products
     *
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  \Flipdish\\Client\Models\CreateMenuSectionItemFromProducts $create_from_products Menu section item (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function createMenuSectionItemFromProducts($menu_id, $menu_section_id, $create_from_products)
    {
        list($response) = $this->createMenuSectionItemFromProductsWithHttpInfo($menu_id, $menu_section_id, $create_from_products);
        return $response;
    }

    /**
     * Operation createMenuSectionItemFromProductsWithHttpInfo
     *
     * Create menu section items from a list of Products
     *
     * @param  int $menu_id Menu identifier (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function createMenuSectionItemFromProductsWithHttpInfo($menu_id, $menu_section_id, $create_from_products)
    {
        $returnType = 'object';
        $request = $this->createMenuSectionItemFromProductsRequest($menu_id, $menu_section_id, $create_from_products);
    ...
    /**
     * Operation createMenuSectionItemFromProductsAsync
     *
     * Create menu section items from a list of Products
     *
     * @param  int $menu_id Menu identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createMenuSectionItemFromProductsAsync($menu_id, $menu_section_id, $create_from_products)
    {
        return $this->createMenuSectionItemFromProductsAsyncWithHttpInfo($menu_id, $menu_section_id, $create_from_products)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createMenuSectionItemFromProductsAsyncWithHttpInfo
     *
     * Create menu section items from a list of Products
     *
     * @param  int $menu_id Menu identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createMenuSectionItemFromProductsAsyncWithHttpInfo($menu_id, $menu_section_id, $create_from_products)
    {
        $returnType = 'object';
        $request = $this->createMenuSectionItemFromProductsRequest($menu_id, $menu_section_id, $create_from_products);
    ...
    /**
     * Create request for operation 'createMenuSectionItemFromProducts'
     *
     * @param  int $menu_id Menu identifier (required)
     * @param  int $menu_section_id Menu section identifier (required)
     * @param  \Flipdish\\Client\Models\CreateMenuSectionItemFromProducts $create_from_products Menu section item (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createMenuSectionItemFromProductsRequest($menu_id, $menu_section_id, $create_from_products)
    {
        // verify the required parameter 'menu_id' is set
        if ($menu_id === null || (is_array($menu_id) && count($menu_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_id when calling createMenuSectionItemFromProducts'
            );
        }
        // verify the required parameter 'menu_section_id' is set
        if ($menu_section_id === null || (is_array($menu_section_id) && count($menu_section_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $menu_section_id when calling createMenuSectionItemFromProducts'
            );
        }
        // verify the required parameter 'create_from_products' is set
        if ($create_from_products === null || (is_array($create_from_products) && count($create_from_products) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_from_products when calling createMenuSectionItemFromProducts'
            );
        }

        $resourcePath = '/api/v1.0/menus/{menuId}/sections/{menuSectionId}/sectionitems/add-products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($create_from_products)) {
            $_tempBody = $create_from_products;
        }
