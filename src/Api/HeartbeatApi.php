...
class HeartbeatApi
{
    ...
    {
        list($response) = $this->headHostnameWithHttpInfo();
        return $response;
    }

    /**
     * Operation headHostnameWithHttpInfo
     *
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function headHostnameAsync()
    {
        return $this->headHostnameAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation headHostnameAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    /**
     * Create request for operation 'headHostname'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function headHostnameRequest()
    {

        $resourcePath = '/api/v1.0/heartbeat/Hostname';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->headPingWithHttpInfo();
        return $response;
    }
    ...
    protected function headPingRequest()
    {
        ...
        $resourcePath = '/api/v1.0/heartbeat';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->hostnameWithHttpInfo();
        return $response;
    }

    /**
     * Operation hostnameWithHttpInfo
     *
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function hostnameAsync()
    {
        return $this->hostnameAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation hostnameAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    /**
     * Create request for operation 'hostname'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function hostnameRequest()
    {
