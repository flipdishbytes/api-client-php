...
class DeliveryZoneApi
{
     ...
     * @return \Flipdish\Client\Models\RestApiResultDeliveryZone
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Models\RestApiResultDeliveryZone, HTTP status code, HTTP response headers (array of strings)
     */
    public function addDeliveryZoneWithHttpInfo($store_id, $delivery_zone_base)
    {
        $returnType = '\Flipdish\Client\Models\RestApiResultDeliveryZone';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Models\RestApiResultDeliveryZone',
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\Client\Models\RestApiArrayResultDeliveryZone
     */
     ...
     * @throws \Flipdish\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\Client\Models\RestApiArrayResultDeliveryZone, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDeliveryZonesWithHttpInfo($store_id)
    {
        $returnType = '\Flipdish\Client\Models\RestApiArrayResultDeliveryZone';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\Client\Models\RestApiArrayResultDeliveryZone',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
