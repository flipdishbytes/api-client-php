...
class FilesApi
{
    ...
    {
        list($response) = $this->downloadFileWithHttpInfo($app_id, $file_id);
        return $response;
    }
     ...
     */
    public function downloadFileAsync($app_id, $file_id)
    {
        return $this->downloadFileAsyncWithHttpInfo($app_id, $file_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function downloadFileRequest($app_id, $file_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling downloadFile'
            );
        }
        ...
        $resourcePath = '/api/v1.0/{appId}/files/download/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
