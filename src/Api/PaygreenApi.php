...
class PaygreenApi
{
    ...
    /**
     * Operation getStorePayGreenConfiguration
     *
     * @param  string $app_id app_id (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     ...
     */
    public function getStorePayGreenConfiguration($app_id)
    {
        list($response) = $this->getStorePayGreenConfigurationWithHttpInfo($app_id);
        return $response;
    }

    /**
     * Operation getStorePayGreenConfigurationWithHttpInfo
     *
     * @param  string $app_id (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     ...
     */
    public function getStorePayGreenConfigurationWithHttpInfo($app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultRestaurantVoucherEligibleStore';
        $request = $this->getStorePayGreenConfigurationRequest($app_id);
    ...
    /**
     * Operation getStorePayGreenConfigurationAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorePayGreenConfigurationAsync($app_id)
    {
        return $this->getStorePayGreenConfigurationAsyncWithHttpInfo($app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStorePayGreenConfigurationAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStorePayGreenConfigurationAsyncWithHttpInfo($app_id)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiArrayResultRestaurantVoucherEligibleStore';
        $request = $this->getStorePayGreenConfigurationRequest($app_id);
    ...
    /**
     * Create request for operation 'getStorePayGreenConfiguration'
     *
     * @param  string $app_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStorePayGreenConfigurationRequest($app_id)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling getStorePayGreenConfiguration'
            );
        }
