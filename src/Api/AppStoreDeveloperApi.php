...
class AppStoreDeveloperApi
{
    ...
    /**
     * Operation getAppExternalProduct
     *
     * @param  string $oauth_app_id oauth_app_id (required)
     * @param  string $app_store_app_id app_store_app_id (required)
     *
     ...
     * @return void
     */
    public function getAppExternalProduct($oauth_app_id, $app_store_app_id)
    {
        $this->getAppExternalProductWithHttpInfo($oauth_app_id, $app_store_app_id);
    }

    /**
     * Operation getAppExternalProductWithHttpInfo
     *
     * @param  string $oauth_app_id (required)
     * @param  string $app_store_app_id (required)
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAppExternalProductWithHttpInfo($oauth_app_id, $app_store_app_id)
    {
        $returnType = '';
        $request = $this->getAppExternalProductRequest($oauth_app_id, $app_store_app_id);
    ...
    /**
     * Operation getAppExternalProductAsync
     *
     * 
     *
     * @param  string $oauth_app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppExternalProductAsync($oauth_app_id, $app_store_app_id)
    {
        return $this->getAppExternalProductAsyncWithHttpInfo($oauth_app_id, $app_store_app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAppExternalProductAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $oauth_app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppExternalProductAsyncWithHttpInfo($oauth_app_id, $app_store_app_id)
    {
        $returnType = '';
        $request = $this->getAppExternalProductRequest($oauth_app_id, $app_store_app_id);
    ...
    /**
     * Create request for operation 'getAppExternalProduct'
     *
     * @param  string $oauth_app_id (required)
     * @param  string $app_store_app_id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAppExternalProductRequest($oauth_app_id, $app_store_app_id)
    {
        // verify the required parameter 'oauth_app_id' is set
        if ($oauth_app_id === null || (is_array($oauth_app_id) && count($oauth_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $oauth_app_id when calling getAppExternalProduct'
            );
        }
        // verify the required parameter 'app_store_app_id' is set
        if ($app_store_app_id === null || (is_array($app_store_app_id) && count($app_store_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_store_app_id when calling getAppExternalProduct'
            );
        }

        $resourcePath = '/api/v1.0/oauthclients/{oauthAppId}/appstore/apps/{appStoreAppId}/external_product';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getExternalFunctionSigningKeyWithHttpInfo($oauth_app_id, $app_store_app_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExternalFunctionSigningKeyAsync($oauth_app_id, $app_store_app_id)
    {
        return $this->getExternalFunctionSigningKeyAsyncWithHttpInfo($oauth_app_id, $app_store_app_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExternalFunctionSigningKeyRequest($oauth_app_id, $app_store_app_id)
    {
        // verify the required parameter 'oauth_app_id' is set
        if ($oauth_app_id === null || (is_array($oauth_app_id) && count($oauth_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $oauth_app_id when calling getExternalFunctionSigningKey'
            );
        }
        // verify the required parameter 'app_store_app_id' is set
        if ($app_store_app_id === null || (is_array($app_store_app_id) && count($app_store_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_store_app_id when calling getExternalFunctionSigningKey'
            );
        }

        $resourcePath = '/api/v1.0/oauthclients/{oauthAppId}/appstore/apps/{appStoreAppId}/external_function_signing_key';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation updateExternalProduct
     *
     * @param  string $oauth_app_id oauth_app_id (required)
     * @param  string $app_store_app_id app_store_app_id (required)
     * @param  \Flipdish\\Client\Models\UpdateAppStoreAppExternalProduct $app_store_app_external_product app_store_app_external_product (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateExternalProduct($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
    {
        $this->updateExternalProductWithHttpInfo($oauth_app_id, $app_store_app_id, $app_store_app_external_product);
    }

    /**
     * Operation updateExternalProductWithHttpInfo
     *
     * @param  string $oauth_app_id (required)
     * @param  string $app_store_app_id (required)
     * @param  \Flipdish\\Client\Models\UpdateAppStoreAppExternalProduct $app_store_app_external_product (required)
     *
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateExternalProductWithHttpInfo($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
    {
        $returnType = '';
        $request = $this->updateExternalProductRequest($oauth_app_id, $app_store_app_id, $app_store_app_external_product);
    ...
    /**
     * Operation updateExternalProductAsync
     *
     * 
     *
     * @param  string $oauth_app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateExternalProductAsync($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
    {
        return $this->updateExternalProductAsyncWithHttpInfo($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateExternalProductAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $oauth_app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateExternalProductAsyncWithHttpInfo($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
    {
        $returnType = '';
        $request = $this->updateExternalProductRequest($oauth_app_id, $app_store_app_id, $app_store_app_external_product);
    ...
    /**
     * Create request for operation 'updateExternalProduct'
     *
     * @param  string $oauth_app_id (required)
     * @param  string $app_store_app_id (required)
     * @param  \Flipdish\\Client\Models\UpdateAppStoreAppExternalProduct $app_store_app_external_product (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateExternalProductRequest($oauth_app_id, $app_store_app_id, $app_store_app_external_product)
    {
        // verify the required parameter 'oauth_app_id' is set
        if ($oauth_app_id === null || (is_array($oauth_app_id) && count($oauth_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $oauth_app_id when calling updateExternalProduct'
            );
        }
        // verify the required parameter 'app_store_app_id' is set
        if ($app_store_app_id === null || (is_array($app_store_app_id) && count($app_store_app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_store_app_id when calling updateExternalProduct'
            );
        }
        // verify the required parameter 'app_store_app_external_product' is set
        if ($app_store_app_external_product === null || (is_array($app_store_app_external_product) && count($app_store_app_external_product) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_store_app_external_product when calling updateExternalProduct'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($app_store_app_external_product)) {
            $_tempBody = $app_store_app_external_product;
        }
