...
class SubscriptionsApi
{
    ...
    /**
     * Operation hasCustomerGotPaymentMethodOnFile
     *
     * @param  string $app_id app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Flipdish\\Client\Models\RestApiResultHasPaymentMethodResponse
     */
    public function hasCustomerGotPaymentMethodOnFile($app_id, $email = null)
    {
        list($response) = $this->hasCustomerGotPaymentMethodOnFileWithHttpInfo($app_id, $email);
        return $response;
    }

    /**
     * Operation hasCustomerGotPaymentMethodOnFileWithHttpInfo
     *
     * @param  string $app_id (required)
     ...
     * @throws \Flipdish\\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Flipdish\\Client\Models\RestApiResultHasPaymentMethodResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function hasCustomerGotPaymentMethodOnFileWithHttpInfo($app_id, $email = null)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultHasPaymentMethodResponse';
        $request = $this->hasCustomerGotPaymentMethodOnFileRequest($app_id, $email);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Flipdish\\Client\Models\RestApiResultHasPaymentMethodResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation hasCustomerGotPaymentMethodOnFileAsync
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function hasCustomerGotPaymentMethodOnFileAsync($app_id, $email = null)
    {
        return $this->hasCustomerGotPaymentMethodOnFileAsyncWithHttpInfo($app_id, $email)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation hasCustomerGotPaymentMethodOnFileAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $app_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function hasCustomerGotPaymentMethodOnFileAsyncWithHttpInfo($app_id, $email = null)
    {
        $returnType = '\Flipdish\\Client\Models\RestApiResultHasPaymentMethodResponse';
        $request = $this->hasCustomerGotPaymentMethodOnFileRequest($app_id, $email);
    ...
    /**
     * Create request for operation 'hasCustomerGotPaymentMethodOnFile'
     *
     * @param  string $app_id (required)
     * @param  string $email (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function hasCustomerGotPaymentMethodOnFileRequest($app_id, $email = null)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling hasCustomerGotPaymentMethodOnFile'
            );
        }

        $resourcePath = '/api/v1.0/{appId}/subscriptions/hasPaymentMethod';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
