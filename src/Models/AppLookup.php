...
/**
 * AppLookup Class Doc Comment
 *
 * @category Class
 * @description App lookup model
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AppLookup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppLookup';
     ...
     * Sets opportunity_id
     *
     * @param string $opportunity_id Sales force opportunity id
     *
     * @return $this
     */
