...
/**
 * UserMonthlyCommission Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserMonthlyCommission implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserMonthlyCommission';
     ...
     * Sets month_start
     *
     * @param \DateTime $month_start The start date of the month for which the commission is calculated.
     *
     * @return $this
     */
     ...
     *
     * @param double $commission_amount The total commission amount for the user in the specified month.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency The currency in which the commission is paid.
     *
     * @return $this
     */
     ...
     * Sets iso_currency
     *
     * @param string $iso_currency The ISO currency code for the commission currency.
     *
     * @return $this
     */
