...
/**
 * HydraStoreUnassignedEvent Class Doc Comment
 *
 * @category Class
 * @description Hydra store\\s unassigned event
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HydraStoreUnassignedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HydraStoreUnassignedEvent';
     ...
     * Sets store_ids
     *
     * @param int[] $store_ids Store\\s to unassign hydra from
     *
     * @return $this
     */
