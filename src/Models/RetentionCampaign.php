...
class RetentionCampaign implements ModelInterface, ArrayAccess
{
    ...
    public function setNotifyCustomerAfterMinutes($notify_customer_after_minutes)
    {
        ...
        if (!is_null($notify_customer_after_minutes) && ($notify_customer_after_minutes > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $notify_customer_after_minutes when calling RetentionCampaign., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($notify_customer_after_minutes) && ($notify_customer_after_minutes < 1440)) {
            throw new \InvalidArgumentException('invalid value for $notify_customer_after_minutes when calling RetentionCampaign., must be bigger than or equal to 1440.');
        }
    ...
    public function setPercentDiscountAmount($percent_discount_amount)
    {
        ...
        if (!is_null($percent_discount_amount) && ($percent_discount_amount > 100)) {
            throw new \InvalidArgumentException('invalid value for $percent_discount_amount when calling RetentionCampaign., must be smaller than or equal to 100.');
        }
        if (!is_null($percent_discount_amount) && ($percent_discount_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $percent_discount_amount when calling RetentionCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxDiscount($max_discount)
    {
        ...
        if (!is_null($max_discount) && ($max_discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_discount when calling RetentionCampaign., must be bigger than or equal to 0.');
        }
    ...
    public function setLumpDiscountAmount($lump_discount_amount)
    {
        ...
        if (!is_null($lump_discount_amount) && ($lump_discount_amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $lump_discount_amount when calling RetentionCampaign., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($lump_discount_amount) && ($lump_discount_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $lump_discount_amount when calling RetentionCampaign., must be bigger than or equal to 0.');
        }
    ...
    public function setVoucherValidPeriodDays($voucher_valid_period_days)
    {
        ...
        if (!is_null($voucher_valid_period_days) && ($voucher_valid_period_days > 300)) {
            throw new \InvalidArgumentException('invalid value for $voucher_valid_period_days when calling RetentionCampaign., must be smaller than or equal to 300.');
        }
        if (!is_null($voucher_valid_period_days) && ($voucher_valid_period_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $voucher_valid_period_days when calling RetentionCampaign., must be bigger than or equal to 1.');
        }
