...
/**
 * HydraRequestResetEvent Class Doc Comment
 *
 * @category Class
 * @description Hydra request reset event
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HydraRequestResetEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HydraRequestResetEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Models\UserEventInfo $user User who initiated the change
     *
     * @return $this
     */
