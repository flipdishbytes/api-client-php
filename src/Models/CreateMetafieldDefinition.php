...
class CreateMetafieldDefinition implements ModelInterface, ArrayAccess
{
    ...
    public function setKey($key)
    {
        if ((mb_strlen($key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $key when calling CreateMetafieldDefinition., must be smaller than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateMetafieldDefinition., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 400)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateMetafieldDefinition., must be smaller than or equal to 400.');
        }
