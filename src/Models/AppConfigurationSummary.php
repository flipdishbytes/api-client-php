...
/**
 * AppConfigurationSummary Class Doc Comment
 *
 * @category Class
 * @description Application Configuration Summary  &lt;remarks&gt;Header information for display in lists, like list of apps&lt;/remarks&gt;
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AppConfigurationSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppConfigurationSummary';
     ...
     * Sets id
     *
     * @param string $id Application Configuration Public Id
     *
     * @return $this
     */
     ...
     * Sets app_id
     *
     * @param string $app_id Whitelabel App Id
     *
     * @return $this
     */
     ...
     *
     * @param \Flipdish\\Client\Models\ConfiguredPhysicalRestaurant[] $physical_restaurants List of restaurants
     *
     * @return $this
     */
     ...
     *
     * @param string $app_store_app_id AppStore App Id
     *
     * @return $this
     */
