...
/**
 * CreateCatalogGroup Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateCatalogGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateCatalogGroup';
    ...
    protected static $swaggerTypes = [
        ...
        'items' => '\Flipdish\\Client\Models\CreateCatalogItemReference[]',
     ...
     * Gets items
     *
     * @return \Flipdish\\Client\Models\CreateCatalogItemReference[]
     */
     ...
     * Sets items
     *
     * @param \Flipdish\\Client\Models\CreateCatalogItemReference[] $items Collection of items associated with this group
     *
     * @return $this
     */
    ...
    {
        if ((mb_strlen($sku) > 30)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateCatalogGroup., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateCatalogGroup., must be bigger than or equal to 0.');
        }
    ...
    public function setImageFileName($image_file_name)
    {
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling CreateCatalogGroup., must be smaller than or equal to 512.');
        }
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling CreateCatalogGroup., must be bigger than or equal to 0.');
        }
