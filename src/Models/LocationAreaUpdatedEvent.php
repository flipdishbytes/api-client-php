...
/**
 * LocationAreaUpdatedEvent Class Doc Comment
 *
 * @category Class
 * @description Event for logging updates of LocationAreas
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocationAreaUpdatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LocationAreaUpdatedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User who updated the LocationArea
     *
     * @return $this
     */
