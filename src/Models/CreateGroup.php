...
class CreateGroup implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'products' => '\Flipdish\\Client\Models\CreateProductReference[]',
     ...
     * Gets products
     *
     * @return \Flipdish\\Client\Models\CreateProductReference[]
     */
     ...
     * Sets products
     *
     * @param \Flipdish\\Client\Models\CreateProductReference[] $products Collection of items associated with this group
     *
     * @return $this
     */
    ...
    {
        if ((mb_strlen($sku) > 30)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateGroup., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateGroup., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 300)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateGroup., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateGroup., must be bigger than or equal to 0.');
        }
    ...
    public function setImageFileName($image_file_name)
    {
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling CreateGroup., must be smaller than or equal to 512.');
        }
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling CreateGroup., must be bigger than or equal to 0.');
        }
