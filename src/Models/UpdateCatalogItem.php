...
/**
 * UpdateCatalogItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateCatalogItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateCatalogItem';
    ...
    protected static $swaggerTypes = [
        ...
        'alcohol' => 'bool',
        'groups' => '\Flipdish\\Client\Models\UpdateCatalogGroupReference[]',
    ...
    public function setSku($sku)
    {
        if (!is_null($sku) && (mb_strlen($sku) > 30)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling UpdateCatalogItem., must be smaller than or equal to 30.');
        }
        if (!is_null($sku) && (mb_strlen($sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling UpdateCatalogItem., must be bigger than or equal to 0.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if (!is_null($price) && ($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling UpdateCatalogItem., must be bigger than or equal to 0.');
        }
    ...
    public function setImageFileName($image_file_name)
    {
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling UpdateCatalogItem., must be smaller than or equal to 512.');
        }
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling UpdateCatalogItem., must be bigger than or equal to 0.');
        }
     ...
     * Gets groups
     *
     * @return \Flipdish\\Client\Models\UpdateCatalogGroupReference[]
     */
     ...
     * Sets groups
     *
     * @param \Flipdish\\Client\Models\UpdateCatalogGroupReference[] $groups Collection of groups associated with this item
     *
     * @return $this
     */
