...
/**
 * UpdateGroupReference Class Doc Comment
 *
 * @category Class
 * @description Data to update a {Flipdish.PublicModels.V1.Catalog.Products.GroupReference}
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateGroupReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateGroupReference';
    ...
    public function setCatalogGroupId($catalog_group_id)
    {
        if ((mb_strlen($catalog_group_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $catalog_group_id when calling UpdateGroupReference., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($catalog_group_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $catalog_group_id when calling UpdateGroupReference., must be bigger than or equal to 0.');
        }
