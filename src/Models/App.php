...
class App implements ModelInterface, ArrayAccess
{
    ...
    const APP_RESOURCE_SET_VIEW_CHANNEL_AUDIT_LOGS = 'ViewChannelAuditLogs';
    const APP_RESOURCE_SET_VIEW_APP_STORE_AUDIT_LOGS = 'ViewAppStoreAuditLogs';
    ...
    const APP_RESOURCE_SET_VIEW_CLIENT_AUDIT_LOGS = 'ViewClientAuditLogs';
    ...
    const APP_RESOURCE_SET_UPDATE_APP_STORE_APP_CONFIGURATION_SETTINGS = 'UpdateAppStoreAppConfigurationSettings';
    const APP_RESOURCE_SET_CREATE_APP_STORE_SUBSCRIPTION = 'CreateAppStoreSubscription';
    const APP_RESOURCE_SET_UPDATE_APP_STORE_SUBSCRIPTION = 'UpdateAppStoreSubscription';
    const APP_RESOURCE_SET_DELETE_APP_STORE_SUBSCRIPTION = 'DeleteAppStoreSubscription';
    ...
    public function getAppResourceSetAllowableValues()
    {
        return [
            ...
            self::APP_RESOURCE_SET_VIEW_CHANNEL_AUDIT_LOGS,
            self::APP_RESOURCE_SET_VIEW_APP_STORE_AUDIT_LOGS,
            ...
            self::APP_RESOURCE_SET_VIEW_CLIENT_AUDIT_LOGS,
            ...
            self::APP_RESOURCE_SET_UPDATE_APP_STORE_APP_CONFIGURATION_SETTINGS,
            self::APP_RESOURCE_SET_CREATE_APP_STORE_SUBSCRIPTION,
            self::APP_RESOURCE_SET_UPDATE_APP_STORE_SUBSCRIPTION,
            self::APP_RESOURCE_SET_DELETE_APP_STORE_SUBSCRIPTION,
    ...
    /**
     * Gets google_maps_api_key_web
     *
     * @return string
     */
    public function getGoogleMapsApiKeyWeb()
    {
        return $this->container['google_maps_api_key_web'];
    }

    /**
     * Sets google_maps_api_key_web
     *
     * @param string $google_maps_api_key_web Key to be passed with Google Maps requests
     *
     * @return $this
     */
