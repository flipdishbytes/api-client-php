...
class App implements ModelInterface, ArrayAccess
{
    ...
    const APP_RESOURCE_SET_VIEW_FEES_CONFIGURATIONS = 'ViewFeesConfigurations';
    const APP_RESOURCE_SET_EDIT_FEES_CONFIGURATIONS = 'EditFeesConfigurations';
    ...
    public function getAppResourceSetAllowableValues()
    {
        return [
            ...
            self::APP_RESOURCE_SET_VIEW_FEES_CONFIGURATIONS,
            self::APP_RESOURCE_SET_EDIT_FEES_CONFIGURATIONS,
