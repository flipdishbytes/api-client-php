...
/**
 * StoreLogoDeletedEvent Class Doc Comment
 *
 * @category Class
 * @description Store logo deleted
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreLogoDeletedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreLogoDeletedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User who removed the logo
     *
     * @return $this
     */
