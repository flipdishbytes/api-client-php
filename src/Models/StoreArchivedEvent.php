...
/**
 * StoreArchivedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Archived Event
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreArchivedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreArchivedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User which archived this store
     *
     * @return $this
     */
     ...
     * Sets store
     *
     * @param \Flipdish\\Client\Models\Store $store Archived Store
     *
     * @return $this
     */
