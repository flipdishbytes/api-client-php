...
/**
 * StoreUnarchivedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Unarchived Event
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreUnarchivedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreUnarchivedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User which unarchived this store
     *
     * @return $this
     */
     ...
     * Sets store
     *
     * @param \Flipdish\\Client\Models\Store $store Unarchived Store
     *
     * @return $this
     */
