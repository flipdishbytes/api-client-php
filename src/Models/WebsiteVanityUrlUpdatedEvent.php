...
/**
 * WebsiteVanityUrlUpdatedEvent Class Doc Comment
 *
 * @category Class
 * @description Website vanity url
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebsiteVanityUrlUpdatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebsiteVanityUrlUpdatedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User who has updated the url
     *
     * @return $this
     */
     ...
     * Sets vanity_url
     *
     * @param string $vanity_url New vanity url
     *
     * @return $this
     */
