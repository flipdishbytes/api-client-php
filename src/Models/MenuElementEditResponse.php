...
class MenuElementEditResponse implements ModelInterface, ArrayAccess
{
    ...
    const MENU_ELEMENT_TYPE_MENU_ITEM = 'MenuItem';
    const MENU_ELEMENT_TYPE_MENU_OPTION_SET_ITEM = 'MenuOptionSetItem';
    ...
    {
        return [
            self::MENU_ELEMENT_TYPE_MENU_ITEM,
            self::MENU_ELEMENT_TYPE_MENU_OPTION_SET_ITEM,
        ];
    }
