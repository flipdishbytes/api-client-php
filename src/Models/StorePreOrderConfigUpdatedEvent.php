...
/**
 * StorePreOrderConfigUpdatedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Pre order config updated
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StorePreOrderConfigUpdatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorePreOrderConfigUpdatedEvent';
    ...
    /**
     * Gets pre_order_config
     *
     * @return \Flipdish\\Client\Models\PreOrderConfig
     */
    public function getPreOrderConfig()
    {
        return $this->container['pre_order_config'];
    }

    /**
     * Sets pre_order_config
     *
     * @param \Flipdish\\Client\Models\PreOrderConfig $pre_order_config Pre Order Configuration
     *
     * @return $this
     */
