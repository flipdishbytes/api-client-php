...
class Subscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'string',
        'user_id' => 'int',
        'subscription_plan' => '\Flipdish\Client\Models\SubscriptionPlan',
        'card' => '\Flipdish\Client\Models\Card',
        'app_id' => 'string',
        'vat_number' => 'string',
     ...
     *
     * @param \Flipdish\Client\Models\SubscriptionPlan $subscription_plan Subscription Plan
     *
     * @return $this
     */
     ...
     * Sets card
     *
     * @param \Flipdish\Client\Models\Card $card Card
     *
     * @return $this
     */
