...
/**
 * StorePublishedEvent Class Doc Comment
 *
 * @category Class
 * @description Store Published Event
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StorePublishedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorePublishedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User which published this store
     *
     * @return $this
     */
     ...
     * Sets store
     *
     * @param \Flipdish\\Client\Models\Store $store Published Store
     *
     * @return $this
     */
