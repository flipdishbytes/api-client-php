...
class UpdateProduct implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 300)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProduct., must be smaller than or equal to 300.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateProduct., must be smaller than or equal to 3000.');
        }
