...
class UpdateProduct implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'alcohol' => 'bool',
        'groups' => '\Flipdish\\Client\Models\UpdateGroupReference[]',
    ...
    public function setSku($sku)
    {
        if (!is_null($sku) && (mb_strlen($sku) > 30)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling UpdateProduct., must be smaller than or equal to 30.');
        }
        if (!is_null($sku) && (mb_strlen($sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling UpdateProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProduct., must be smaller than or equal to 200.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateProduct., must be smaller than or equal to 1000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setImageFileName($image_file_name)
    {
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling UpdateProduct., must be smaller than or equal to 512.');
        }
        if (!is_null($image_file_name) && (mb_strlen($image_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_file_name when calling UpdateProduct., must be bigger than or equal to 0.');
        }
     ...
     * Gets groups
     *
     * @return \Flipdish\\Client\Models\UpdateGroupReference[]
     */
     ...
     * Sets groups
     *
     * @param \Flipdish\\Client\Models\UpdateGroupReference[] $groups Collection of groups associated with this item
     *
     * @return $this
     */
