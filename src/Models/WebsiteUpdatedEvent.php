...
/**
 * WebsiteUpdatedEvent Class Doc Comment
 *
 * @category Class
 * @description WebsiteUpdatedEvent
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebsiteUpdatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebsiteUpdatedEvent';
     ...
     * Sets app_name_id
     *
     * @param string $app_name_id App Name id of the whitelabel of the website
     *
     * @return $this
     */
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Models\UserEventInfo $user User updating the website
     *
     * @return $this
     */
