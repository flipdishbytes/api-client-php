...
/**
 * LocationAreaCreatedEvent Class Doc Comment
 *
 * @category Class
 * @description Event for logging creating of LocationAreas
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocationAreaCreatedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LocationAreaCreatedEvent';
     ...
     *
     * @param string $location_area_id LocationArea Id
     *
     * @return $this
     */
     ...
     *
     * @param string $location_area_name LocationArea name
     *
     * @return $this
     */
     ...
     * Sets user
     *
     * @param \Flipdish\\Client\Models\UserEventInfo $user User who created the LocationArea
     *
     * @return $this
     */
