...
class MenuItemOptionSetBase implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MenuItemOptionSetBase., must be smaller than or equal to 4000.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MenuItemOptionSetBase., must be bigger than or equal to 0.');
        }
