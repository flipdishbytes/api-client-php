 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateCatalogGroupReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateCatalogGroupReference';
    ...
    public function setCatalogGroupId($catalog_group_id)
    {
        if ((mb_strlen($catalog_group_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $catalog_group_id when calling CreateCatalogGroupReference., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($catalog_group_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $catalog_group_id when calling CreateCatalogGroupReference., must be bigger than or equal to 0.');
        }
    ...
    public function setCatalogItemId($catalog_item_id)
    {
        if (!is_null($catalog_item_id) && (mb_strlen($catalog_item_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $catalog_item_id when calling CreateCatalogGroupReference., must be smaller than or equal to 30.');
        }
        if (!is_null($catalog_item_id) && (mb_strlen($catalog_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $catalog_item_id when calling CreateCatalogGroupReference., must be bigger than or equal to 0.');
        }
