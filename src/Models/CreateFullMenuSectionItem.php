...
/**
 * CreateFullMenuSectionItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateFullMenuSectionItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateFullMenuSectionItem';
    ...
    protected static $swaggerTypes = [
        'menu_item_option_sets' => '\Flipdish\\Client\Models\CreateFullMenuItemOptionSet[]',
     ...
     *
     * @return \Flipdish\\Client\Models\CreateFullMenuItemOptionSet[]
     */
     ...
     *
     * @param \Flipdish\\Client\Models\CreateFullMenuItemOptionSet[] $menu_item_option_sets Menu item option sets
     *
     * @return $this
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateFullMenuSectionItem., must be smaller than or equal to 4000.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateFullMenuSectionItem., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateFullMenuSectionItem., must be smaller than or equal to 4000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateFullMenuSectionItem., must be bigger than or equal to 0.');
        }
