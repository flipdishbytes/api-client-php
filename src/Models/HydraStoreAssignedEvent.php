...
/**
 * HydraStoreAssignedEvent Class Doc Comment
 *
 * @category Class
 * @description Hydra store\\s assigned event
 * @package  Flipdish\\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HydraStoreAssignedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HydraStoreAssignedEvent';
     ...
     * Sets store_ids
     *
     * @param int[] $store_ids Store\\s to assign hydra to
     *
     * @return $this
     */
