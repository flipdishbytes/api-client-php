...
/**
 * BankAccountDeletedEvent Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Flipdish\\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountDeletedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAccountDeletedEvent';
     ...
     * Sets bank_account
     *
     * @param \Flipdish\\Client\Models\BankAccount $bank_account The create bank account
     *
     * @return $this
     */
