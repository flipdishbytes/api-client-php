...
/**
 * StoreMenuAssignedEvent Class Doc Comment
 *
 * @category Class
 * @description Menu Assigned To Store Event
 * @package  Flipdish\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoreMenuAssignedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StoreMenuAssignedEvent';
     ...
     * Sets user
     *
     * @param \Flipdish\Client\Models\UserEventInfo $user User who assigned the menu to the store
     *
     * @return $this
     */
