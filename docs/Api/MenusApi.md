...
> \Flipdish\Client\Models\RestApiArrayResultMenuElementEditResponse menusShowHideBulkItems($menu_id, $menu_elements, $hide, $undo_after)
...
try {
    $result = $apiInstance->menusShowHideBulkItems($menu_id, $menu_elements, $hide, $undo_after);
    print_r($result);
} catch (Exception $e) {
