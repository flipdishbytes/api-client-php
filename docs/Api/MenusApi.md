...
> object menusIsWhiteLabelMigratedToRms($white_label_id, $app_id)
...
$white_label_id = 56; // int | white label id (integer)
$app_id = "app_id_example"; // string | appId (string)

try {
    $result = $apiInstance->menusIsWhiteLabelMigratedToRms($white_label_id, $app_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MenusApi->menusIsWhiteLabelMigratedToRms: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **white_label_id** | **int**| white label id (integer) | [optional]
 **app_id** | **string**| appId (string) | [optional]
...
> object menusMarkWhiteLabelAsMigratedToRms($white_label_id, $app_id)
...
try {
    $result = $apiInstance->menusMarkWhiteLabelAsMigratedToRms($white_label_id, $app_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MenusApi->menusMarkWhiteLabelAsMigratedToRms: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> object menusMarkWhiteLabelAsNotMigratedToRms($white_label_id, $app_id)
...
try {
    $result = $apiInstance->menusMarkWhiteLabelAsNotMigratedToRms($white_label_id, $app_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MenusApi->menusMarkWhiteLabelAsNotMigratedToRms: ', $e->getMessage(), PHP_EOL;
}
?>
```
