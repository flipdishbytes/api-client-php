...
> \Flipdish\\Client\Models\RestApiResultAppStoreConfigModel getWhiteLabelAppStoreConfig($app_id)
...
try {
    $result = $apiInstance->getWhiteLabelAppStoreConfig($app_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WhiteLabelConfigApi->getWhiteLabelAppStoreConfig: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Flipdish\\Client\Models\RestApiResultAppStoreConfigModel updateWhiteLabelAppStoreConfig($app_id, $app_store_config)
...
try {
    $result = $apiInstance->updateWhiteLabelAppStoreConfig($app_id, $app_store_config);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WhiteLabelConfigApi->updateWhiteLabelAppStoreConfig: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $result = $apiInstance->whiteLabelConfigHealthCheck();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WhiteLabelConfigApi->whiteLabelConfigHealthCheck: ', $e->getMessage(), PHP_EOL;
}
?>
```
