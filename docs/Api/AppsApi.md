...
# **appsSetPropertyId**
> object appsSetPropertyId($app_id, $org_id)
...
try {
    $result = $apiInstance->appsSetPropertyId($app_id, $org_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AppsApi->appsSetPropertyId: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getAppName**
> \Flipdish\\Client\Models\RestApiStringResult getAppName($app_id)
...
try {
    $result = $apiInstance->getAppName($app_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AppsApi->getAppName: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> sendPushNotification($app_id, $customer_id, $message)
...
try {
    $apiInstance->sendPushNotification($app_id, $customer_id, $message);
} catch (Exception $e) {
    echo 'Exception when calling AppsApi->sendPushNotification: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> setThirdPartyIntegrations($app_id, $enabled)
...
try {
    $apiInstance->setThirdPartyIntegrations($app_id, $enabled);
} catch (Exception $e) {
    echo 'Exception when calling AppsApi->setThirdPartyIntegrations: ', $e->getMessage(), PHP_EOL;
}
?>
```
