...
> \Flipdish\\Client\Models\RestApiResultPayoutReport3PropertyDetails getPayoutReport3PropertyDetails($app_id, $bank_account_id, $payout_id, $property_ids, $store_ids)
...
try {
    $result = $apiInstance->getPayoutReport3PropertyDetails($app_id, $bank_account_id, $payout_id, $property_ids, $store_ids);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PayoutReportsApi->getPayoutReport3PropertyDetails: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Flipdish\\Client\Models\RestApiResultPayoutReport3PropertyDetails**](../Model/RestApiResultPayoutReport3PropertyDetails.md)
...
[**\Flipdish\\Client\Models\RestApiResultPayoutReport3StorePayouts**](../Model/RestApiResultPayoutReport3StorePayouts.md)
