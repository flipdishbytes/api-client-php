...
$is_enabled = true; // bool | Is enabled

try {
    $result = $apiInstance->getVouchers($app_id, $page_index, $page_size, $search_codes, $status_search, $type_search, $sub_type_search, $store_ids, $is_enabled);
    print_r($result);
} catch (Exception $e) {
